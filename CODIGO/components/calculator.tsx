...
export default function Calculator() {
    ...
    function tipoDoImc() {
        if (imc < 18.5) {
            return <strong className={styles.sub}>Abaixo do peso</strong>;
        } else if (imc < 24.9) {
            return <strong className={styles.normal}>Peso Normal</strong>;
        } else if (imc < 29.9) {
            return <strong className={styles.med}>Sobrepeso</strong>;
        } else if (imc < 34.9) {
            return <strong className={styles.grau1}>Obesidade grau 1</strong>;
        } else if (imc < 39.9) {
            return <strong className={styles.grau2}>Obesidade grau 2</strong>;
        } else {
            return <strong className={styles.grau3}>Obesidade grau 3</strong>;
        }
    }
